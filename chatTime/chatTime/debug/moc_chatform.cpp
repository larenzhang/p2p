...
**
** Created: Tue Oct 11 21:48:26 2016
...
static const char qt_meta_stringdata_chatForm[] = {
    "chatForm\0\0on_sendButton_clicked()\0"
};

const QMetaObject chatForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_chatForm,
      qt_meta_data_chatForm, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &chatForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_chatForm))
